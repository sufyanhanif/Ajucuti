            ...
            <div class="card mt-5">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-3">
                  <div>
                    <a class="btn btn-primary" href="{{ route('ajucutis.create') }}">Ajukan Cuti</a>
                  </div>
                  <div>
                          ...
                          <div class="btn-group" role="group">
                            ...
                            @else
                              <table>
                                <tr>
                                  <td>
                                    <a href="{{ route('ajucutis.edit', $ajucuti->id) }}" class="btn btn-secondary btn-sm">Edit</a>
                                  </td>
                                  <td>
                                    <form action="{{ route('ajucutis.destroy', $ajucuti->id) }}" method="POST">
                                      @csrf
