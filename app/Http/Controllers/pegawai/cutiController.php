...
class cutiController extends Controller
{
    public function index()
    {
        ...
        return view('pegawai.cuti.index', compact('ajucutis'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ajucuti.index')->with('success', 'Pengajuan cuti berhasil diajukan');
    }
    ...
    return view('pegawai.cuti.edit', compact('ajucuti'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ajucuti.index')->with('success', 'Pengajuan cuti berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($ajucuti->delete()) {
            return redirect(route('ajucuti.index'))->with('success', 'Batal Mengajukan cuti');
        }

        return redirect(route('ajucuti.index'))->with('error', 'Sorry, unable to delete this!');
    }
}
